...
{
    ::ImGui::RenderColorRectWithAlphaCheckerboard(reinterpret_cast<::ImDrawList*>(draw_list), ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), col, alpha, grid_step, ConvertToCPP_ImVec2(grid_off), 0.0f, 0);
}
